...
void sendToServer(String DEVICE_ID){
  ...
  if(client.connect(SERVER, 80)) {
    ...
    client.println("Host: 10.8.107.209"); // <== MAKE SURE SET THIS SERVER IP OR DOMAIN WEB
