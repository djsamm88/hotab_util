...
unsigned int data6[1]; // ENERGY       ==> 3206
...
unsigned int data6_2[1]; // ENERGY       ==> 3206
...
unsigned int data6_3[1]; // ENERGY       ==> 3206
...
unsigned int data6_4[1]; // ENERGY       ==> 3206
...
unsigned int data6_5[1]; // ENERGY       ==> 3206
...
unsigned int data6_6[1]; // ENERGY       ==> 3206
...
float meterData[36]; // converted registers (float) will be stored here and send to server with http request
...
void modbusData_2(){
  ...
  convertDataInt(packet6_2,data6_2);
}
...
void modbusData_3(){
  ...
  convertDataInt(packet6_3,data6_3);
}
...
void modbusData_4(){
  ...
  convertDataInt(packet6_4,data6_4);
}
