...
<table id="tbl_newsnya" class="table  table-striped table-bordered"  cellspacing="0" width="100%">
      ...
      <tbody>
        ...
        {
			$x->price = $x->price+500;//agen
			
			$x->product_name = $x->product_name=='Voucher Axis Data Mini 1 GB / 3 Hari'?'Voucher Axis Data Mini 2 GB / 3 Hari_':$x->product_name;
			$x->product_name = $x->product_name=='Voucher Axis Data Mini 1 GB / 5 Hari'?'Voucher Axis Data Mini 2 GB / 5 Hari_':$x->product_name;
			$x->product_name = $x->product_name=='Voucher Axis Data Mini 2 GB / 5 Hari'?'Voucher Axis Data Mini 3 GB / 5 Hari_':$x->product_name;
			$x->product_name = $x->product_name=='Voucher Axis Data Mini 3 GB / 5 Hari'?'Voucher Axis Data Mini 5 GB / 5 Hari_':$x->product_name;
			$x->product_name = $x->product_name=='Voucher Axis Data Mini 5 GB / 5 Hari'?'Voucher Axis Data Mini 8 GB / 5 Hari_':$x->product_name;
