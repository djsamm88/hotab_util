...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url()?>assets/orgchart/orgchart.css">
...
<div class="wrapper">
    ...
    <nav class="navbar navbar-static-top" role="navigation">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li> <a href="#" class="navbar"><b>Utility Meter</b></a></li>
          ...
          <li class="dropdown messages-menu t4_saldo">
            ...
            <ul class="dropdown-menu ">
              <li class="header t4_saldo">- :<span class="t4_notif_saldo"></span> </li>
              <li>
  ...
  <footer class="main-footer">
    ...
    <div class="pull-right hidden-xs">
      Sistem Informasi Utility
    </div>
    <!-- Default to the left -->
    <strong>Copyright - hotabilardus.com &copy;  2022 - <?php echo date('Y')?> - <a href="#">-</a>.</strong> All rights reserved.
  </footer>
...
<script type="text/javascript">var assets_url = "<?php echo base_url()?>assets/orgchart/";</script>
<script src="<?php echo base_url()?>assets/orgchart/orgchart.js"></script>
