          ...
          <form id="go_trx_jurnal">
              ...
              <div class="col-sm-3">
                <select class="form-control" name="Device_ID" id="Device_ID" required>
                  <option value=""> -- Pilih Power Meter -- </option>
                  <?php 
...
if($go!=0)
{
  include "part_laporan_power_meter.php";
...
$("#go_trx_jurnal").on("submit",function(){
    ...
    eksekusi_controller('<?php echo base_url()?>index.php/welcome/laporan_power_meter/?go=1&mulai='+mulai+'&selesai='+selesai+'&Device_ID='+Device_ID,'Laporan Power Meter');
  return false;
})
...
$("#download_pdf").on("click",function(){
  ...
  var url="<?php echo base_url()?>index.php/welcome/laporan_power_meter_xl/?"+ser;
  window.open(url);
