...
if($go!=0)
{
  include "part_laporan_flowmeter_steam.php";
...
$("#go_trx_jurnal").on("submit",function(){
    ...
    eksekusi_controller('<?php echo base_url()?>index.php/welcome/laporan_flowmeter_steam/?go=1&mulai='+mulai+'&selesai='+selesai+'&Device_ID='+Device_ID,'Laporan Power Meter');
  return false;
})
...
$("#download_pdf").on("click",function(){
  ...
  var url="<?php echo base_url()?>index.php/welcome/laporan_flowmeter_steam_xl/?"+ser;
  window.open(url);
