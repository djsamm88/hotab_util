    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <form id="form_tambah_admin">
            ...
            <div class="col-sm-4">Username <small><i>(for Login)</i></small></div>
            <div class="col-sm-8"><input type="text" name="user_admin" id="user_admin" required="required" class="form-control" placeholder="user_admin"></div>
            <div style="clear: both;"></div><br>
